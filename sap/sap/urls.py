...
urlpatterns = [
    ...
    path('detalle-persona/<int:id>', detallePersona),
    path('nueva-persona', nuevaPersona),
    path('editar-persona/<int:id>', editarPersona),
    path('eliminar-persona/<int:id>', eliminarPersona),
]
